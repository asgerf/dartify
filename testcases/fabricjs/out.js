...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  _IsolateContext: {
    ...
    _updateGlobalState$0: function() {
      if (this.ports.__js_helper$_length - this.weakPorts._length > 0 || this.isPaused || !this.initialized)
  ...
  _Deserializer: {
    ...
    }, "call$1", "get$deserialize", 2, 0, 2, 3],
...
["dart.collection", "dart:collection", , P, {
  ...
  }, "call$1", "_defaultHashCode$closure", 2, 0, 14, 13],
  ...
  _HashMap: {
    ...
    $indexSet: function(_, key, value) {
      var nums, rest, hash, bucket, index;
  ...
  _LinkedHashSet: {
    "^": "_HashSetBase;_length,_strings,_nums,_rest,_collection$_first,_collection$_last,_collection$_modifications",
    get$iterator: function(_) {
  ...
  Maps_mapToString_closure: {
    "^": "Closure:7;_collection$_box_0,_captured_result_1",
    call$2: function(k, v) {
      var t1, t2;
...
["dart.js", "dart:js", , P, {
  ...
  }, null, null, 8, 0, null, 14, 15, 16, 17],
  ...
  }, "call$1", "_convertToJS$closure", 2, 0, 2, 18],
  ...
  }, "call$1", "_convertToDart$closure", 2, 0, 17, 18],
...
["fabricjs", "fabricjs.dart", , B, {
  "^": "",
  _: function(x) {
    var t1 = !J.getInterceptor(x).$isMap;
    if (!t1 || false) {
      if (t1 && true)
        H.throwExpression(P.ArgumentError$("object must be a Map or Iterable"));
      return P._wrapToDart(P.JsObject__convertDataTree(x));
    }
    return x;
  },
  _Proxy: {
  ...
  _Object: {
    "^": "_Proxy;",
    toString$0: function(_) {
      return this.jsvalue.callMethod$2("toString", []);
    }
  },
  _StaticCanvas: {
    "^": "_Proxy;",
...
["", "main.dart", , F, {
  ...
  main: [function() {
    ...
    t1 = P.JsObject_JsObject($.get$_Canvas__constructor(), [B._("c"), B._(null)]);
    t2 = P.LinkedHashMap_LinkedHashMap$_literal(["width", 200, "height", 100, "left", 0, "top", 50, "angle", 30, "fill", "rgba(255,0,0,0.5)"], null, null);
    t2 = P.JsObject_JsObject($.get$_Rect__constructor(), [B._(t2)]);
    t3 = P.LinkedHashMap_LinkedHashMap$_literal(["width", 100, "height", 100, "left", 350, "top", 250, "angle", -10, "fill", "rgba(0,200,0,0.5)"], null, null);
    t3 = P.JsObject_JsObject($.get$_Rect__constructor(), [B._(t3)]);
    t4 = P.LinkedHashMap_LinkedHashMap$_literal(["width", 50, "height", 100, "left", 275, "top", 350, "angle", 45, "fill", "rgba(0,0,200,0.5)"], null, null);
    t4 = P.JsObject_JsObject($.get$_Rect__constructor(), [B._(t4)]);
    t5 = P.LinkedHashMap_LinkedHashMap$_literal(["radius", 50, "left", 275, "top", 75, "fill", "#aac"], null, null);
    t5 = P.JsObject_JsObject($.get$_Circle__constructor(), [B._(t5)]);
    t6 = P.LinkedHashMap_LinkedHashMap$_literal(["width", 100, "height", 100, "left", 50, "top", 300, "fill", "#cca"], null, null);
    t1.callMethod$2("add", [t2, t3, t4, t5, P.JsObject_JsObject($.get$_Triangle__constructor(), [B._(t6)])]);
    t1.callMethod$2("on", [B._("object:moving"), B._(new F.main_onChange(new B._Canvas(t1)))]);
  }, "call$0", "main$closure", 0, 0, 0],
  main_onChange: {
    "^": "Closure:10;_captured_canvas_0",
    call$1: [function(options) {
      J.$index$asx(options, "target").callMethod$2("setCoords", []);
      this._captured_canvas_0.jsvalue.callMethod$2("forEachObject", [B._(new F.main_onChange_closure(options)), B._(null)]);
    }, null, null, 2, 0, null, 19, "call"]
  },
  main_onChange_closure: {
    "^": "Closure:11;_captured_options_1",
    call$3: [function(obj, a, b) {
      var t1, t2;
      t1 = this._captured_options_1;
      t2 = J.getInterceptor$asx(t1);
      if (J.$eq(obj, t2.$index(t1, "target")))
        return;
      obj.callMethod$2("setOpacity", [t2.$index(t1, "target").callMethod$2("intersectsWithObject", [obj]) === true ? 0.5 : 1]);
    }, null, null, 6, 0, null, 20, 13, 21, "call"]
  }
},
1],
...
}, "_dartProxyCtor", "_Canvas__constructor", "get$_Canvas__constructor", function() {
  return J.$index$asx(J.$index$asx($.get$context(), "fabric"), "Canvas");
}, "_constructor", "_Circle__constructor", "get$_Circle__constructor", function() {
  return J.$index$asx(J.$index$asx($.get$context(), "fabric"), "Circle");
}, "_constructor", "_Triangle__constructor", "get$_Triangle__constructor", function() {
  return J.$index$asx(J.$index$asx($.get$context(), "fabric"), "Triangle");
}, "_constructor", "_Rect__constructor", "get$_Rect__constructor", function() {
  return J.$index$asx(J.$index$asx($.get$context(), "fabric"), "Rect");
}, "_constructor"]);
;
